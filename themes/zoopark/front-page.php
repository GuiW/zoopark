...
<!-- FRONT-PAGE -->
    ...
    <div class="section no-pad-bot">
      <div class="slogan container">
        ...
        <div class="row center">
          <h2 class="header col s12 light">Un parc entièrement dédié à la découverte et la protection des espèces</h2>
        </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h3 class="header col s12 light">Une réserve incomparable</h3>
        </div>
      </div>
    </div>
  ...
  <div class="opening container">
    <div class="section">
      <div class="row">
        ...
        <div id="spring" class="col s12"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed unde, natus excepturi autem quae dolore repellat voluptas ipsa esse perferendis, incidunt eius nulla rem accusantium, voluptatem, impedit amet non doloribus.</p></div>
        <div id="summer" class="col s12"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat autem maiores vero laudantium maxime, optio, voluptatibus, fuga aperiam laboriosam molestiae cumque dignissimos ipsa aut possimus, consequuntur totam temporibus. Maiores, adipisci, et?</p></div>
        <div id="winter" class="col s12"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde iste nesciunt, minima corporis dolore itaque porro molestiae! Numquam.</p></div>
      </div>
    </div>
  </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h3 class="header col s12 light">Des balades au cœur des sentiers sauvages</h3>
        </div>
      </div>
    </div>
